...
type WorkspaceFigmaSourceMode = "rest";
/** Allowed codegen modes for workspace-dev. */
type WorkspaceLlmCodegenMode = "deterministic";
...
export { CONTRACT_VERSION, type WorkspaceFigmaSourceMode, type WorkspaceJobInput, type WorkspaceJobResult, type WorkspaceLlmCodegenMode, type WorkspaceStartOptions, type WorkspaceStatus, type WorkspaceVersionInfo };
