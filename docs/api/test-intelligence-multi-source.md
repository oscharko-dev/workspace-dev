...
**Contract version:** `TEST_INTELLIGENCE_CONTRACT_VERSION = "1.14.0"`<br>
**Package contract version:** `CONTRACT_VERSION = "4.53.0"`<br>
**Authoritative surface:** `CONTRACT_CHANGELOG.md` §4.11.0–4.53.0
...
- `CONTRACT_CHANGELOG.md` §4.11.0–4.53.0 — authoritative contract surface
