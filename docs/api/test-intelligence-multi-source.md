...
**Contract version:** `TEST_INTELLIGENCE_CONTRACT_VERSION = "1.3.0"`  
**Package contract version:** `CONTRACT_VERSION = "4.14.0"`  
**Authoritative surface:** `CONTRACT_CHANGELOG.md` §4.11.0–4.14.0
...
- `CONTRACT_CHANGELOG.md` §4.11.0–4.14.0 — authoritative contract surface
