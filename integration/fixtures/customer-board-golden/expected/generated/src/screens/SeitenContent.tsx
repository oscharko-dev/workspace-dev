...
const sharedSxStyle1 = { height: "24px", color: "text.secondary", width: "2.5%", maxWidth: "24px", minHeight: "24px", flexDirection: "row", display: "flex", alignItems: "center", justifyContent: "center" };
