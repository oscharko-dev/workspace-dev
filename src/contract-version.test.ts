...
const EXPECTED_CONTRACT_RUNTIME_EXPORTS = [
  ...
  "ALLOWED_AUDIT_DOSSIER_ARTIFACT_KINDS",
  ...
  "ALLOWED_JUDGE_AVAILABILITY_STATES",
  "ALLOWED_JUDGE_REFUSAL_POLICIES",
  ...
  "ALLOWED_TEST_CASE_ORACLE_POLARITIES",
