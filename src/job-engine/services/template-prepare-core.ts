...
interface TemplatePrepareServiceOptions {
  applyFreshTemplateMutation?: (context: StageRuntimeContext) => Promise<void>;
}

export const createTemplatePrepareService = ({
  applyFreshTemplateMutation,
}: TemplatePrepareServiceOptions = {}): StageService<void> => ({
  ...
  execute: async (_input, context) => {
    ...
    if (!seededFromSourceProject) {
      await applyFreshTemplateMutation?.(context);
    }
