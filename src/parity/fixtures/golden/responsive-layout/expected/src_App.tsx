...
import HomeDesktopScreen from "./screens/Home_Desktop";
  ...
  return (
    <BrowserRouter basename={browserBasename}>
      ...
      <Suspense fallback={routeLoadingFallback}>
        <Routes>
          <Route path="/home_desktop" element={<ErrorBoundary><HomeDesktopScreen /></ErrorBoundary>} />
          <Route path="/" element={<Navigate to="/home_desktop" replace />} />
          <Route path="*" element={<Navigate to="/home_desktop" replace />} />
        </Routes>
      </Suspense>
    </BrowserRouter>
