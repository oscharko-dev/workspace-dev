...
export default function OnboardingScreen() {
  return (
    <Container id="main-content" maxWidth="sm" role="main" sx={{ position: "relative", width: "100%", minHeight: "max(100vh, 320px)", bgcolor: "background.paper", px: 1, py: 1 }}>
      ...
      <Typography data-ir-id="onb-body" data-ir-name="Body" variant="body1" sx={{ color: "text.secondary", textAlign: "left", whiteSpace: "pre-wrap" }}>{"Let us set up your account in a few easy steps."}</Typography>
      {/* @ir:end onb-body */}
    </Container>
  );
}
