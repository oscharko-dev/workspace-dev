...
function HomeDesktopScreenContent() {
  return (
    <Container id="main-content" maxWidth="xl" role="main" sx={{ position: "relative", width: "100%", minHeight: "max(100vh, 724px)", bgcolor: "background.paper", px: 1.333, py: 1.333, maxWidth: { xs: "390px", sm: "none", lg: "1440px", xl: "none" }, gap: { xs: 1.333, sm: 2 } }}>
