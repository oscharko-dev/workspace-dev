...
export default function DashboardDarkScreen() {
  return (
    <Container id="main-content" maxWidth="sm" role="main" sx={{ position: "relative", width: "100%", minHeight: "max(100vh, 320px)", bgcolor: "#12141c", px: 1.143, py: 1.143 }}>
      ...
      <Typography data-ir-id="dark-title" data-ir-name="Heading" variant="h1" component="h1" sx={{ color: "background.paper", textAlign: "left", whiteSpace: "pre-wrap" }}>{"Operations Dashboard"}</Typography>
      {/* @ir:end dark-title */}
      ...
      <Card data-ir-id="dark-summary-card" data-ir-name="Summary Card" component="article" sx={{ width: "87.7%", maxWidth: "342px", minHeight: "144px", display: "flex", flexDirection: "column", gap: 0.571, p: 1.143, bgcolor: "#1f242e" }}>
        <CardContent>
          ...
          <Typography data-ir-id="dark-card-value" data-ir-name="Value" variant="h2" component="h2" sx={{ color: "background.paper", textAlign: "left", whiteSpace: "pre-wrap" }}>{"14 urgent reviews"}</Typography>
