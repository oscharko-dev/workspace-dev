...
export default function ProductListScreen() {
  return (
    <Container id="main-content" maxWidth="sm" role="main" sx={{ position: "relative", width: "100%", minHeight: "max(100vh, 704px)", bgcolor: "#f5f7fa", px: 1.333, py: 1.333 }}>
      ...
      <Box data-ir-id="product-card-1" data-ir-name="Product Card" sx={sharedSxStyle1}>
      ...
      <Box data-ir-id="product-card-2" data-ir-name="Product Card" sx={sharedSxStyle1}>
      ...
      <Box data-ir-id="product-card-3" data-ir-name="Product Card" sx={sharedSxStyle1}>
      ...
      <Box data-ir-id="product-card-4" data-ir-name="Product Card" sx={sharedSxStyle1}>
      ...
      <Box data-ir-id="product-card-5" data-ir-name="Product Card" sx={sharedSxStyle1}>
      ...
      <Box data-ir-id="product-card-6" data-ir-name="Product Card" sx={sharedSxStyle1}>
