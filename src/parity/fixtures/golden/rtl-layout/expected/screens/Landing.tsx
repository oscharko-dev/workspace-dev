...
export default function LandingScreen() {
  return (
    <Container id="main-content" maxWidth="sm" role="main" sx={{ position: "relative", width: "100%", minHeight: "max(100vh, 404px)", bgcolor: "background.paper", px: 1.333, py: 1.333 }}>
      ...
      <Paper data-ir-id="rtl-cta" data-ir-name="CTA Button" aria-hidden="true" sx={{ position: "relative", width: "87.7%", maxWidth: "342px", minHeight: "48px", bgcolor: "info.main", borderRadius: 1 }}>
        ...
        <Typography data-ir-id="rtl-cta-label" data-ir-name="Label" variant="subtitle1" sx={{ position: "absolute", left: "126px", top: "12px", lineHeight: "1.5rem", color: "background.paper", textAlign: "center", whiteSpace: "pre-wrap" }}>{"ابدأ الآن"}</Typography>
