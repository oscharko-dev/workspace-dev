...
test("renders generated Risk Alert Modal Board app in a real browser", async ({ page }) => {
  await page.goto("/");

  await expect(page.getByTestId("generated-app")).toBeVisible();
});

test("captures visual audit evidence for the generated Risk Alert Modal Board app", async ({ page }, testInfo) => {
