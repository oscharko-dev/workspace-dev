...
test("renders generated Unsupported Pattern Coverage Board app in a real browser", async ({ page }) => {
  await page.goto("/");

  await expect(page.getByTestId("generated-app")).toBeVisible();
});

test("captures visual audit evidence for the generated Unsupported Pattern Coverage Board app", async ({ page }, testInfo) => {
