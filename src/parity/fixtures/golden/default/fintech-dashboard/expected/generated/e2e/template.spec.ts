...
test("renders generated Global Banking Dashboard Board app in a real browser", async ({ page }) => {
  await page.goto("/");

  await expect(page.getByTestId("generated-app")).toBeVisible();
});

test("captures visual audit evidence for the generated Global Banking Dashboard Board app", async ({ page }, testInfo) => {
