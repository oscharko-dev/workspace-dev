...
test("renders generated Responsive Banking Portal Board app in a real browser", async ({ page }) => {
  await page.goto("/");

  await expect(page.getByTestId("generated-app")).toBeVisible();
});

test("captures visual audit evidence for the generated Responsive Banking Portal Board app", async ({ page }, testInfo) => {
