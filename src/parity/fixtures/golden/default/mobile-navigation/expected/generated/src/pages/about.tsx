export default function About() {
  return (
    <main className="min-h-screen w-full flex flex-col gap-[16px] min-h-[844px] w-full max-w-[390px] p-[24px] bg-[#ffffff]">
      ...
      <p data-ir-id="about-body" data-ir-name="Body" className="w-[342px] h-[24px] text-[16px] text-[#1c1f24] leading-[24px] font-[400] whitespace-pre-wrap">{"Built with care by the engineering team."}</p>
    </main>
  );
}
