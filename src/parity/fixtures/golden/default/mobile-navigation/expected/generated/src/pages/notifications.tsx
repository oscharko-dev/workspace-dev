export default function Notifications() {
  return (
    <main className="min-h-screen w-full flex flex-col gap-[8px] min-h-[844px] w-full max-w-[390px] p-[16px] bg-[#ffffff]">
      ...
      <p data-ir-id="notif-empty" data-ir-name="Empty State" className="w-full max-w-[358px] h-[20px] text-[14px] text-[#999ea8] leading-[20px] font-[400] text-center whitespace-pre-wrap">{"No new notifications"}</p>
    </main>
  );
}
