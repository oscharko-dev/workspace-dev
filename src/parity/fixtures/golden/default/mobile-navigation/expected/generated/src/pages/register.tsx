export default function Register() {
  return (
    <main className="min-h-screen w-full flex flex-col gap-[16px] min-h-[844px] w-full max-w-[390px] px-[24px] pt-[48px] pb-[24px] bg-[#ffffff]">
      ...
      <input data-ir-id="reg-name" data-ir-name="Text Field" className="flex flex-row justify-between items-center gap-[8px] min-h-[56px] w-[342px]" type="text" name="textField" aria-label="Full Name" />
    </main>
  );
}
