export default function Search() {
  return (
    <main className="min-h-screen w-full flex flex-col gap-[16px] min-h-[844px] w-full max-w-[390px] p-[16px] bg-[#ffffff]">
      ...
      <input data-ir-id="search-field" data-ir-name="Text Field" className="flex flex-row justify-between items-center gap-[8px] min-h-[48px] w-full max-w-[358px]" type="text" name="textField" aria-label="Search" />
    </main>
  );
}
