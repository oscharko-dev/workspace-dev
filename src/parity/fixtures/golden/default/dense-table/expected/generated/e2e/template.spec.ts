...
test("renders generated Transaction Table Board app in a real browser", async ({ page }) => {
  await page.goto("/");

  await expect(page.getByTestId("generated-app")).toBeVisible();
});

test("captures visual audit evidence for the generated Transaction Table Board app", async ({ page }, testInfo) => {
