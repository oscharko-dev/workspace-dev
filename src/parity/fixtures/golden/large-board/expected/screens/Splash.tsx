...
export default function SplashScreen() {
  return (
    <Container id="main-content" maxWidth="sm" role="main" sx={{ position: "relative", width: "100%", minHeight: "max(100vh, 320px)", bgcolor: "secondary.main", px: 1, py: 1 }}>
      ...
      <Typography data-ir-id="splash-title" data-ir-name="Title" variant="h1" component="h1" sx={{ color: "background.paper", textAlign: "center", whiteSpace: "pre-wrap" }}>{"AppName"}</Typography>
      {/* @ir:end splash-title */}
