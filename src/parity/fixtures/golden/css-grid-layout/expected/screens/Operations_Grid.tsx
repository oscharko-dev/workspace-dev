...
export default function OperationsGridScreen() {
  return (
    <Container id="main-content" maxWidth="lg" role="main" sx={{ position: "relative", width: "100%", minHeight: "max(100vh, 638px)", bgcolor: "#f7fafc", px: 0.8, py: 0.8 }}>
      ...
      <Box data-ir-id="analytics-matrix" data-ir-name="Analytics Matrix" sx={{ display: "grid", gridTemplateColumns: "1fr 1fr", gridTemplateRows: "auto auto auto", gap: 2, position: "relative", width: "95.1%", maxWidth: "932px", minHeight: "540px" }}>
        <Box sx={{ gridRow: "1 / 3" }}>
          ...
          <Box data-ir-id="grid-area-nav" data-ir-name="grid-area-nav" sx={{ position: "absolute", left: "0px", top: "0px", width: "220px", minHeight: "324px", bgcolor: "#ffffff", borderRadius: 1 }}>
          ...
          <Box data-ir-id="grid-area-stats" data-ir-name="grid-area-stats" sx={{ position: "absolute", left: "236px", top: "208px", width: "696px", minHeight: "116px", bgcolor: "#ffffff", borderRadius: 1 }}>
