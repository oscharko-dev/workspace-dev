...
function ID0034NettoBetriebsmittelAlleClusterExpandedScreenContent() {
  return (
...
export default function ID0034NettoBetriebsmittelAlleClusterExpandedScreen() {
  return (
      <AppShell1>
        <ID0034NettoBetriebsmittelAlleClusterExpandedScreenContent />
      </AppShell1>
  );
}
