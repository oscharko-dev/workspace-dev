...
export const TI_EVAL_FILES = Object.freeze([
  ...
  "src/test-intelligence/poc-eval.test.ts",
  "src/test-intelligence/poc-fixtures.test.ts",
  "src/test-intelligence/poc-harness.self-verify.test.ts",
  "src/test-intelligence/poc-harness.test.ts",
  "src/test-intelligence/poc-harness.visual-captures.test.ts",
