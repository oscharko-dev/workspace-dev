...
export const TI_EVAL_FILES = Object.freeze([
  ...
  "src/test-intelligence/agent-lessons-eval.test.ts",
  ...
  "src/test-intelligence/calculation-constraints.test.ts",
  ...
  "src/test-intelligence/customer-markdown-pdf-mappe.test.ts",
  ...
  "src/test-intelligence/human-review-audit-bundle.test.ts",
  "src/test-intelligence/human-review-calibration.test.ts",
  "src/test-intelligence/human-review-http-routes.test.ts",
  "src/test-intelligence/human-review-queue.test.ts",
  ...
  "src/test-intelligence/locale-calibration-health.test.ts",
  "src/test-intelligence/locale-calibration.test.ts",
  ...
  "src/test-intelligence/tenant-isolation-proof.test.ts",
